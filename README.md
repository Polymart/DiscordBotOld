...
5. (optional) All verified users can be given a generic "Verified" role which you can set up by using `/config set verification` to set the role, like `/config set verification role:@PolymartVerified`. This will be given to users who own at least 1 of your resources.
